      ...
      <div>
        ...
        <Panel title="AI Provider" meta={aiSettings.provider === 'none' ? 'not configured' : aiSettings.provider} style={{ marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div style={{ padding: '10px 12px', border: '1px solid var(--bd)', background: 'var(--bg-2)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <button
                    onClick={() => { navigator.clipboard.writeText('OLLAMA_ORIGINS=* ollama serve'); toast('ok', 'Copied!'); }}
          ...
          <div style={{ marginTop: 16, display: 'flex', alignItems: 'center', gap: 12 }}>
            <button
              onClick={() => { setAiSettings(aiSettings); setAiSaved(true); setTimeout(() => setAiSaved(false), 2000); toast('ok', 'AI settings saved'); }}
